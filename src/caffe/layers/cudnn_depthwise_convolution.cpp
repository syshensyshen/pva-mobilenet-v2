...
#define CUDNN_STREAMS_PER_GROUP 1
	...
	*/
	...
	void CuDNNDepthwiseConvolutionLayer<Dtype>::LayerSetUp(
	...
	template <typename Dtype>
	void CuDNNDepthwiseConvolutionLayer<Dtype>::Reshape(
		const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
		DepthwiseConvolutionLayer<Dtype>::Reshape(bottom, top);
	...
	template <typename Dtype>
	CuDNNDepthwiseConvolutionLayer<Dtype>::~CuDNNDepthwiseConvolutionLayer() {
	...
	INSTANTIATE_CLASS(CuDNNDepthwiseConvolutionLayer);
